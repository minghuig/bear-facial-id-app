...
export default function Journey(){
 ...
 function undo(){if(before){setCollection(before);setBefore(null);setComparing(false);setNotice('Change undone. The previous identities have been restored.');}}
